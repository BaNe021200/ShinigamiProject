...
(function($) {
    ...
    // Disables selection.
    $.fn.disableSelection_dropotron = function() { return $(this).css('actions-select', 'none').css('-khtml-actions-select', 'none').css('-moz-actions-select', 'none').css('-o-actions-select', 'none').css('-webkit-actions-select', 'none'); };
    ...
    $.dropotron = function(options) {
        ...
        $window
            ...
            .on('keypress', function(e) {
                ...
                // Collapse all menus if the actions hits escape.
